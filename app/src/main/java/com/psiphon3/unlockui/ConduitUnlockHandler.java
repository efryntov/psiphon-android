...
public class ConduitUnlockHandler extends UnlockOptionHandler {
    private static final String PLAYSTORE_CONDUIT_URL = "https://play.google.com/store/apps/details?id=ca.psiphon.conduit";
    private static final String PLAYSTORE_PSIPHON_PRO_URL = "https://play.google.com/store/apps/details?id=com.psiphon3.subscription";
    ...
    private void hideAllConduitViews() {
        if (updatePsiphonProView != null) updatePsiphonProView.setVisibility(View.GONE);
        if (installConduitView != null) installConduitView.setVisibility(View.GONE);
        if (updateConduitView != null) updateConduitView.setVisibility(View.GONE);
        if (openConduitView != null) openConduitView.setVisibility(View.GONE);
    }
